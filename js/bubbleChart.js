class BubbleChart {
  ...
  initVis() {
    ...
    .attr('dy', '.71em')
    .style('text-anchor', 'end')
    .text('Show the people from '  + currBubbleChartSubCategory 
    + 'couples that ranked the quality of their relationship as ' + currBubbleChartMainCategory)
    .style('font-weight', 'bold');
